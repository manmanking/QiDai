...
@interface TaskRankingTableViewCell ()
{
    UIView *_greenView;
}
...
@end
@implementation TaskRankingTableViewCell
...
- (UIImageView *)rankImageView {
    if (!_rankImageView) {
        _rankImageView = [[UIImageView alloc]initWithFrame:CGRectMake720(20, 35, 40, 40)];
    }
    return _rankImageView;
}
- (UILabel *)rankLabel {
    if (!_rankLabel) {
        _rankLabel = [UILabel qd_labelWithFrame:CGRectMake720(20, 35, 40, 40) title:@"1" titleColor:kColorForfff textAlignment:NSTextAlignmentCenter font:24];
    }
    return _rankLabel;
}
