...
@interface QDRootViewController : UIViewController

/** 是否显示返回箭头*/
@property (nonatomic,assign) BOOL isBackBtnShow;

/** 创建导航栏中间的title*/
- (void)creatTitleViewWithString:(NSString *)str;

/** 创建导航栏右边的文字按钮*/
- (void)creatRightBtnWithString:(NSString *)string;
