...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController*)viewController {
    ...
    // 这里的 selectedIndex 指的是上一次点击的tabBarButton的下标
    //NSUInteger selectedIndex = tabBarController.selectedIndex;
    // 这里的 shouldSelectedIndex 指的是即将被点击的tabBarButton的下标
    #pragma mark --- 改动
    NSUInteger shouldSelectedIndex = [tabBarController.viewControllers indexOfObject:viewController];
    if (![[LoginManager instance] isLogin] && shouldSelectedIndex == 1) {
